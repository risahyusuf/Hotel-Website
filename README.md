...
## Overview
This project is a responsive website for finding a hotel. It showcases a hotel website that highlights how to find an apartment for your vacation, reasons to choose the service, Special offers, reviews, how to subscribe to their newsletter, tips for flying on a plane and a footer containing the social media handles. It has a user-friendly layout and aesthetic layout.
...
### Why choose us
- Contains 4 cards highlighting key selling points that differentiate the services as follows;
...
### Newsletter subscription
This contains a container to type in and submit your email to subscribe to the websites newsletter.
